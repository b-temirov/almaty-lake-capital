...
class Backtester:
    ...
    def run(self):
        ...
        # 3. Equity Curve
        self.data['equity_curve'] = (1 + self.data['strategy_returns'].fillna(0)).cumprod() * self.initial_capital
    ...
    def calculate_metrics(self):
        ...
        self.results = {
            'Total Return': (self.data['equity_curve'].iloc[-1] / self.initial_capital) - 1,
            'Sharpe Ratio': sharpe,
